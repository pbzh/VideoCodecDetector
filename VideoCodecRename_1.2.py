...
# Using shared codec constants from codec_common
#----------------------------------------------------------
window = tk.Tk()
#----------------------------------------------------------
# Greeting
...
def add_pressed(event):
    ...
    VideoExtensions = list(VIDEO_EXTENSIONS)
    VideoCodecs = list(VIDEO_CODECS)
    VideoCodecCounts = VIDEO_CODEC_COUNTS_TEMPLATE.copy()
    files = []
    current = 0
